...
#define rssBase @"http://www.iowastatedaily.com/search/?q=&t=article&l=30&d=&d1=&d2=&s=start_time&sd=desc&c[]=%@&f=rss"
- (NSMutableArray *)rssStoriesForCategory:(NSString *)category {
	NSLog(@"Beginning to parse %@", category);
	// must be all lowercase for URL
	NSString *urlStr = [NSString stringWithFormat:rssBase, category];
